...
/**
 * Mapper for the entity {@link Immobilier} and its DTO {@link ImmobilierDTO}.
 */
@Mapper(componentModel = "spring")
public interface ImmobilierMapper extends EntityMapper<ImmobilierDTO, Immobilier> {
    @Mapping(target = "proprietaire", source = "proprietaire", qualifiedByName = "userLogin")
    ...
    ImmobilierDTO toDto(Immobilier s);
